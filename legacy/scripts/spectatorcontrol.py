    ...
    class SpectatorControlConnection(connection):
        ...
        def on_chat(self, value, global_message):
            ...
            if self.team.spectator and spectator_no_chat:
                if not self.admin and not self.rights.specpower and not self.user_types.trusted: # not an admin
        ...
        def check_spec_time(self, id):
            if not self.team.spectator:
                ...
                return
            if self.admin or self.rights.specpower or self.user_types.trusted:
                print 'WARNING 2. Safety check prevented a trusted player from being spectator-kicked.'
                return
            if id == 1:
